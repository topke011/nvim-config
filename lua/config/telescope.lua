...
vim.keymap.set('n', '<leader>?', function() require('telescopepickers').prettyFilesPicker({ picker = 'oldfiles' }) end, { desc = '[?] Find recently opened files' })
...
vim.keymap.set('n', '<leader>sw', function() require('telescopepickers').prettyGrepPicker({ picker = 'grep_string' }) end, { desc = '[S]earch current [W]ord' })
